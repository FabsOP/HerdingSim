...
class TerrainLoader(tk.Tk):
    ...
    def setup_ui(self):
        ...
        prevBtn = tk.Button(
            ...
            bg="#E2F0D9", borderwidth=2, activebackground="#C1E1C1", relief="raised"
        )
    ...
    def upload_heightmap(self):
        ...
        try:
            ...
            # Create new terrain
            new_terrain = Terrain(width, height, invert=False)
            new_terrain.load(file_path, "Grass", levels=15)
    ...
    def delete_heightmap(self):
        ...
        terrain_name = self.savedTerrains[self.selectedTerrainIdx]["name"]
